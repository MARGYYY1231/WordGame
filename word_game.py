...
class MyGUI:
    ...
    def start_page(self, frame):
        ...
        self.bg = tk.PhotoImage(file="Images/background2.png")
        self.four = tk.PhotoImage(file="Images/4_letter.png")
        self.five = tk.PhotoImage(file="Images/5_letter.png")
    ...
    def help(self, frame):
        ...
        self.qmark = tk.PhotoImage(file="Images/question-mark.png")
